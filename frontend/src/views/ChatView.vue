    ...
    <div class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <div class="p-3">
        <div class="relative">
          <input
            type="text"
            placeholder="Поиск..."
            class="w-full px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
      ...
      <div class="flex-1 overflow-y-auto">
        <div class="p-2">
          <div 
            ...
            :key="chat.id"
            :class="[
              'p-3 rounded-lg cursor-pointer flex items-center space-x-3',
      ...
      <div class="p-3 border-t border-gray-200 dark:border-gray-700">
        <div class="flex justify-between">
          ...
          <button @click="logout" class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center px-4">
        <div class="flex items-center space-x-3">
          <div class="w-10 h-10 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center">
            <span class="text-sm font-semibold text-gray-70 dark:text-gray-200">
              {{ selectedChat?.title?.charAt(0) || 'C' }}
            </span>
          </div>
          <div>
            <p class="font-medium">{{ selectedChat?.title || 'Выберите чат' }}</p>
            <p class="text-xs text-gray-500 dark:text-gray-400">в сети</p>
          </div>
        </div>
      </div>
        ...
        <div v-if="selectedChat" class="space-y-3">
          <div 
            ...
            :class="[
              ...
              message.sender_id === authStore.user?.id ? 'ml-auto' : ''
            ]"
          >
            <div 
              :class="[
